class FilterWithApplicantsCountRequisitionSerializer < ActiveModel::Serializer
  ...
  def count_applicants_by_country
    country_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids]).get_applications_of_job_group_by_user_country(object)
  ...
  def count_applicants_by_city
    ...
    city_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids]).get_applications_of_job_group_by_user_city(object)
  ...
  def count_applicants_by_sector
    ...
    sector_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids]).get_applications_of_job_group_by_sector(object)
  ...
  def count_applicants_by_functional_area
    ...
    functional_area_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_job_education
    ...
    job_education_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_nationality
    ...
    nationality_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_visa_status
    ...
    visa_status_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_marital_status
    ...
    marital_status_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_job_type
    ...
    job_type_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_gender
    ...
    gender_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_language
    ...
    language_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_notice_period
    ...
    notice_period_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_experience_range
    ...
    experience_range_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_current_salary_range
    ...
    current_salary_range_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_expected_salary_range
    ...
    expected_salary_range_id_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])
  ...
  def count_applicants_by_age_range
    date_with_applicants_count =  JobApplication.where(jobseeker_id: serialization_options[:applied_jobseeker_ids])

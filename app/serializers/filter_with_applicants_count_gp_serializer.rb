class FilterWithApplicantsCountGpSerializer < ActiveModel::Serializer
  attributes :id, :count_applicants_by_country, :count_applicants_by_city, :count_applicants_by_sector,
             ...
             :count_applicants_by_expected_salary_range, :count_applicants_by_age_range,
  ...
  def count_applicants_by_country
    ...
    country_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_city
    ...
    city_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_sector
    ...
    sector_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_functional_area
    ...
    functional_area_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_job_education
    ...
    job_education_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_nationality
    ...
    nationality_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_visa_status
    ...
    visa_status_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_marital_status
    ...
    marital_status_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_job_type
    ...
    job_type_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_gender
    ...
    gender_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_language
    ...
    language_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_notice_period
    ...
    notice_period_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_experience_range
    ...
    experience_range_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_current_salary_range
    ...
    current_salary_range_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_expected_salary_range
    ...
    expected_salary_range_id_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_age_range
    date_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_master_grade
    master_degree_grade_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_bachelor_grade
    bachelor_degree_grade_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_ielts_score
    ielts_score_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])
  ...
  def count_applicants_by_toefl_score
    toefl_score_with_applicants_count =  JobApplication.where(id: serialization_options[:job_application_ids])

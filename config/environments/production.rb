Rails.application.configure do
  ...
  # endpoint    = "bloovoprod.onwpsf.ng.0001.use1.cache.amazonaws.com:6379"
  ...
  # config.logger = RemoteSyslogLogger.new('logs5.papertrailapp.com', 34102, :program => "bloovo-#{Rails.env}")
  ...
  # This config to send mail using mandrill
  # config.action_mailer.smtp_settings = {
  #     address: "smtp.mandrillapp.com",
  #     authentication: :plain,
  #     domain: Rails.application.secrets['BACKEND'],
  #     enable_starttls_auto: true,
